...
**地位：** 单次 LLM 调用的 Prompt 标准；多 Agent 编排逻辑见 [G5](AI服务编排-织网工作流.md)。
...
本文档定义**单次调用**的 Prompt。多 Agent 之间的协作、对抗、降级、Token 预算等编排逻辑详见 [G5 AI 服务编排](AI服务编排-织网工作流.md)。

---

## 八、相关文档

- 多 Agent 编排：[G5](AI服务编排-织网工作流.md)
- 节点 schema：[G1](数据模型与权限设计.md)
- 文档炸开管线：[G4 §四](文件存储与导入流水线.md)
