...
- 改 API → 先看 [D4-API网关设计](../system-design/D4-API网关设计.md)
- 改数据模型 → 先看 [G1-数据模型与权限设计](../system-design/G1-数据模型与权限设计.md)
- 改 AI → 先看 [G5-AI服务编排](../system-design/G5-AI服务编排-织网工作流.md)
...
**所有涉及节点 state 的改动**必须：
1. 先更新 [G1 §三状态机图](../system-design/G1-数据模型与权限设计.md)
2. 能回答：此状态的前驱 / 后继 / TTL / 可见性 / 可编辑性
3. 写覆盖全部转换的测试
4. 在 [G6](../system-design/G6-可观测性与监控.md) 加对应 metric
...
**Q: 我想改 AI Agent，从哪开始？**
A: 必读 [G5 §2.1 时序图](../system-design/G5-AI服务编排-织网工作流.md) + [G5 §6 成本压缩](../system-design/G5-AI服务编排-织网工作流.md) + [D7 Prompt 规范](../system-design/D7-AI-Prompt工程规范.md)。不熟这三份文档不准碰 AI 层。
...
2. [D0 技术架构总览](../system-design/D0-技术架构总览.md)
3. [G1 数据模型与权限](../system-design/G1-数据模型与权限设计.md)
