...
export default function PlatformAdminManager() {
    ...
    async function handleRevoke(admin) {
        ...
        if (!window.confirm(`确定撤销平台管理员 ${label}？`))
            return;
